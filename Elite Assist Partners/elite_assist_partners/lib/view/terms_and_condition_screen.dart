...
class TermsAndConditionScreen extends StatelessWidget {
  ...
  String terms =
      "These Terms and Conditions govern your use of the Elite Assist mobile application and the services provided therein. By accessing or using the App, you agree to be bound by these Terms. If you do not agree with any part of these Terms, you may not use the App.\n" +
      "\n" +
      "Use of the App :\n" +
      "\n" +
