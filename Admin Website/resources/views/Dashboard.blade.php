          ...
          <div class="card splash-info-card">
              <div class="card-body dd-flex align-items-center">
                  ...
                  <div class="icon-info-text">
                      <h5 class="splash-title">Total Customers</h5>
                      <h4 class="splash-card-title">{{$user_count}}</h4>
                  </div>
              </div>
          </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="card splash-info-card">
              <div class="card-body dd-flex align-items-center">
                  ...
                  <div class="icon-info-text">
                      <h5 class="splash-title">Total Orders</h5>
                      <h4 class="splash-card-title">{{$order_count}}</h4>
                  </div>
              </div>
          </div>
      </div>
          ...
          <div class="card splash-info-card">
              <div class="card-body dd-flex align-items-center">
                  ...
                  <div class="icon-info-text">
                      ...
                      <h4 class="splash-card-title">{{$revenue}}</h4>
                  </div>
              </div>
          </div>
      </div>
                ...
                <div class="card info-card revenue-card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ps-3">
                        <h6>{{$subservice_count}}</h6>
                      </div>
                    </div>
                  </div>
                </div>
              </div><!-- End Sub-Services Card -->
            @else
                <!-- Admins Card -->
              <div class="col-xxl-4 col-md-6">
                <div class="card info-card revenue-card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                        <a href="/AdminsLists" style="text-decoration: none"><i class='bx bx-font'></i></a>
                      </div>
                      <div class="ps-3">
                        <h6>{{$admin_count}}</h6>
                      </div>
