...
class HomeScreen extends StatelessWidget {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            var data =
                                productController.manModel!.product[index];
                            return GestureDetector(
                              onTap: () {
                                Get.to(
                                  () => ProductDetailScreen(
  ...
  Future<void> _onRefresh() async {
    await bannerController.getBanner();
    await serviceController.getService();
    await productController.getAllProduct();
    await productController.getManProducts();
    await productController.getWomanProducts();
  }
}
